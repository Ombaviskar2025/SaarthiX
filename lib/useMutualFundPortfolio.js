...
function useMutualFundPortfolio(rawHoldings, slabRatePct = 30) {
  ...
  // Build aggregate portfolio cash flows for XIRR calculation
  ...
  // Today's Gain estimate (~0.45% average benchmark daily swing simulation based on market index)
