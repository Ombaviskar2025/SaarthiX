...
const STOCKS_DB = [
  ...
  { ticker:'HDFCBANK',   name:'HDFC Bank Ltd.',                exchange:'NSE', sector:'Banking',       price:1783.25,  change:-12.40,  changePct:-0.69, volume:9876543,  mktCap:'13.6L Cr', pe:21.3, high52:1979.90,  low52:1363.55 },
  { ticker:'ICICIBANK',  name:'ICICI Bank Ltd.',               exchange:'NSE', sector:'Banking',       price:1238.60,  change:14.25,   changePct:1.16,  volume:11234567, mktCap:'8.7L Cr',  pe:18.7, high52:1388.35,  low52:945.75  },
  { ticker:'KOTAKBANK',  name:'Kotak Mahindra Bank Ltd.',      exchange:'NSE', sector:'Banking',       price:1892.15,  change:-8.90,   changePct:-0.47, volume:3456789,  mktCap:'3.8L Cr',  pe:19.8, high52:2196.50,  low52:1620.00 },
  { ticker:'AXISBANK',   name:'Axis Bank Ltd.',                exchange:'NSE', sector:'Banking',       price:1156.40,  change:9.75,    changePct:0.85,  volume:7654321,  mktCap:'3.6L Cr',  pe:16.4, high52:1339.65,  low52:895.45  },
  { ticker:'SBIN',       name:'State Bank of India',           exchange:'NSE', sector:'Banking',       price:824.35,   change:6.20,    changePct:0.76,  volume:18234567, mktCap:'7.4L Cr',  pe:12.1, high52:912.10,   low52:543.20  },
  { ticker:'INDUSINDBK', name:'IndusInd Bank Ltd.',            exchange:'NSE', sector:'Banking',       price:1012.45,  change:-18.30,  changePct:-1.78, volume:4321098,  mktCap:'0.8L Cr',  pe:14.2, high52:1694.50,  low52:853.60  },
  { ticker:'BAJFINANCE', name:'Bajaj Finance Ltd.',            exchange:'NSE', sector:'NBFC',          price:6892.30,  change:45.80,   changePct:0.67,  volume:1234567,  mktCap:'4.2L Cr',  pe:35.4, high52:8192.45,  low52:6186.70 },
  { ticker:'BAJAJFINSV', name:'Bajaj Finserv Ltd.',            exchange:'NSE', sector:'NBFC',          price:1712.40,  change:12.35,   changePct:0.73,  volume:987654,   mktCap:'2.7L Cr',  pe:28.6, high52:1990.30,  low52:1419.25 },
  { ticker:'HINDUNILVR', name:'Hindustan Unilever Ltd.',       exchange:'NSE', sector:'FMCG',          price:2456.80,  change:-15.20,  changePct:-0.62, volume:2345678,  mktCap:'5.8L Cr',  pe:55.2, high52:2964.60,  low52:2183.40 },
  { ticker:'ITC',        name:'ITC Ltd.',                      exchange:'NSE', sector:'FMCG',          price:468.25,   change:3.40,    changePct:0.73,  volume:15678901, mktCap:'5.9L Cr',  pe:27.8, high52:528.55,   low52:399.35  },
  { ticker:'NESTLEIND',  name:'Nestle India Ltd.',             exchange:'BSE', sector:'FMCG',          price:2312.65,  change:18.45,   changePct:0.80,  volume:456789,   mktCap:'2.2L Cr',  pe:78.4, high52:2778.00,  low52:2104.90 },
  { ticker:'BRITANNIA',  name:'Britannia Industries Ltd.',     exchange:'NSE', sector:'FMCG',          price:5412.30,  change:-22.45,  changePct:-0.41, volume:234567,   mktCap:'1.3L Cr',  pe:56.7, high52:6012.00,  low52:4512.10 },
  { ticker:'TATACONSUM', name:'Tata Consumer Products Ltd.',   exchange:'NSE', sector:'FMCG',          price:1212.45,  change:8.90,    changePct:0.74,  volume:1234567,  mktCap:'1.1L Cr',  pe:64.2, high52:1388.75,  low52:947.30  },
  { ticker:'MARUTI',     name:'Maruti Suzuki India Ltd.',      exchange:'NSE', sector:'Auto',          price:11245.60, change:124.35,  changePct:1.12,  volume:456789,   mktCap:'3.4L Cr',  pe:28.9, high52:13680.00, low52:9862.50 },
  { ticker:'TATAMOTORS', name:'Tata Motors Ltd.',              exchange:'NSE', sector:'Auto',          price:812.45,   change:-9.80,   changePct:-1.19, volume:9876543,  mktCap:'3.0L Cr',  pe:14.2, high52:1179.00,  low52:738.40  },
  { ticker:'HEROMOTOCO', name:'Hero MotoCorp Ltd.',            exchange:'NSE', sector:'Auto',          price:4812.30,  change:38.20,   changePct:0.80,  volume:345678,   mktCap:'0.96L Cr', pe:22.4, high52:5916.00,  low52:3990.55 },
  { ticker:'EICHERMOT',  name:'Eicher Motors Ltd.',            exchange:'NSE', sector:'Auto',          price:5412.65,  change:45.30,   changePct:0.84,  volume:234567,   mktCap:'1.5L Cr',  pe:32.8, high52:5828.00,  low52:3804.20 },
  { ticker:'M&M',        name:'Mahindra & Mahindra Ltd.',      exchange:'NSE', sector:'Auto',          price:2812.40,  change:28.65,   changePct:1.03,  volume:2345678,  mktCap:'3.5L Cr',  pe:26.7, high52:3222.90,  low52:1694.90 },
  { ticker:'BAJAJ-AUTO', name:'Bajaj Auto Ltd.',               exchange:'NSE', sector:'Auto',          price:8924.30,  change:56.40,   changePct:0.64,  volume:345678,   mktCap:'2.6L Cr',  pe:30.5, high52:12774.35, low52:7408.80 },
  { ticker:'SUNPHARMA',  name:'Sun Pharmaceutical Ind.',       exchange:'NSE', sector:'Pharma',        price:1892.45,  change:14.20,   changePct:0.76,  volume:2345678,  mktCap:'4.5L Cr',  pe:38.2, high52:2175.00,  low52:1375.75 },
  { ticker:'DRREDDY',    name:"Dr. Reddy's Laboratories",      exchange:'NSE', sector:'Pharma',        price:6824.35,  change:-34.15,  changePct:-0.50, volume:456789,   mktCap:'1.1L Cr',  pe:24.6, high52:7645.00,  low52:5231.45 },
  { ticker:'CIPLA',      name:'Cipla Ltd.',                    exchange:'NSE', sector:'Pharma',        price:1612.30,  change:12.45,   changePct:0.78,  volume:1234567,  mktCap:'1.3L Cr',  pe:31.4, high52:1765.00,  low52:1148.80 },
  { ticker:'DIVISLAB',   name:"Divi's Laboratories Ltd.",      exchange:'NSE', sector:'Pharma',        price:4812.65,  change:-22.30,  changePct:-0.46, volume:234567,   mktCap:'1.3L Cr',  pe:68.4, high52:5390.00,  low52:3360.25 },
  { ticker:'APOLLOHOSP', name:'Apollo Hospitals Enterprise',   exchange:'NSE', sector:'Healthcare',    price:7212.45,  change:45.80,   changePct:0.64,  volume:234567,   mktCap:'1.0L Cr',  pe:102.4,high52:7265.00,  low52:4846.50 },
  { ticker:'TATASTEEL',  name:'Tata Steel Ltd.',               exchange:'NSE', sector:'Metals',        price:162.45,   change:-2.80,   changePct:-1.69, volume:34567890, mktCap:'2.0L Cr',  pe:22.4, high52:184.60,   low52:120.60  },
  { ticker:'JSWSTEEL',   name:'JSW Steel Ltd.',                exchange:'NSE', sector:'Metals',        price:924.30,   change:-8.45,   changePct:-0.91, volume:4567890,  mktCap:'2.3L Cr',  pe:26.8, high52:1062.00,  low52:782.10  },
  { ticker:'HINDALCO',   name:'Hindalco Industries Ltd.',      exchange:'NSE', sector:'Metals',        price:712.45,   change:6.80,    changePct:0.96,  volume:5678901,  mktCap:'1.6L Cr',  pe:18.2, high52:770.40,   low52:452.85  },
  { ticker:'COALINDIA',  name:'Coal India Ltd.',               exchange:'NSE', sector:'Mining',        price:524.30,   change:4.15,    changePct:0.80,  volume:7890123,  mktCap:'3.2L Cr',  pe:9.8,  high52:543.55,   low52:382.65  },
  { ticker:'LT',         name:'Larsen & Toubro Ltd.',          exchange:'NSE', sector:'Infrastructure',price:3412.65,  change:28.40,   changePct:0.84,  volume:1234567,  mktCap:'4.9L Cr',  pe:34.2, high52:3994.00,  low52:2727.50 },
  { ticker:'POWERGRID',  name:'Power Grid Corp. of India',     exchange:'NSE', sector:'Utilities',     price:342.45,   change:2.80,    changePct:0.82,  volume:9876543,  mktCap:'3.2L Cr',  pe:19.4, high52:366.25,   low52:205.40  },
  { ticker:'NTPC',       name:'NTPC Ltd.',                     exchange:'NSE', sector:'Utilities',     price:412.30,   change:3.45,    changePct:0.84,  volume:12345678, mktCap:'4.0L Cr',  pe:16.2, high52:448.45,   low52:213.05  },
  { ticker:'ADANIENT',   name:'Adani Enterprises Ltd.',        exchange:'NSE', sector:'Conglomerate',  price:2912.45,  change:-34.20,  changePct:-1.16, volume:2345678,  mktCap:'3.3L Cr',  pe:98.4, high52:3743.90,  low52:2014.55 },
  { ticker:'ADANIPORTS', name:'Adani Ports & SEZ Ltd.',        exchange:'NSE', sector:'Logistics',     price:1412.65,  change:12.45,   changePct:0.89,  volume:3456789,  mktCap:'3.0L Cr',  pe:28.6, high52:1621.35,  low52:869.65  },
  { ticker:'BHARTIARTL', name:'Bharti Airtel Ltd.',            exchange:'NSE', sector:'Telecom',       price:1634.25,  change:18.60,   changePct:1.15,  volume:5678901,  mktCap:'9.8L Cr',  pe:82.4, high52:1779.00,  low52:977.15  },
  { ticker:'ULTRACEMCO', name:'UltraTech Cement Ltd.',         exchange:'NSE', sector:'Cement',        price:11824.35, change:124.30,  changePct:1.06,  volume:345678,   mktCap:'3.4L Cr',  pe:46.8, high52:12684.85, low52:8894.55 },
  { ticker:'GRASIM',     name:'Grasim Industries Ltd.',        exchange:'NSE', sector:'Cement',        price:2812.65,  change:18.40,   changePct:0.66,  volume:456789,   mktCap:'1.9L Cr',  pe:22.4, high52:2889.75,  low52:1885.45 },
  { ticker:'SHREECEM',   name:'Shree Cement Ltd.',             exchange:'BSE', sector:'Cement',        price:26812.45, change:-124.30, changePct:-0.46, volume:56789,    mktCap:'0.97L Cr', pe:48.6, high52:29449.00, low52:21217.15},
  { ticker:'ASIANPAINT', name:'Asian Paints Ltd.',             exchange:'NSE', sector:'Consumer',      price:2284.65,  change:-14.30,  changePct:-0.62, volume:1234567,  mktCap:'2.2L Cr',  pe:52.4, high52:3394.00,  low52:2174.00 },
  { ticker:'TITAN',      name:'Titan Company Ltd.',            exchange:'NSE', sector:'Consumer',      price:3412.30,  change:28.45,   changePct:0.84,  volume:987654,   mktCap:'3.0L Cr',  pe:92.4, high52:3887.00,  low52:3054.35 },
  { ticker:'HDFCLIFE',   name:'HDFC Life Insurance Co.',       exchange:'NSE', sector:'Insurance',     price:724.35,   change:4.80,    changePct:0.67,  volume:2345678,  mktCap:'1.6L Cr',  pe:82.4, high52:791.90,   low52:511.40  },
  { ticker:'SBILIFE',    name:'SBI Life Insurance Co.',        exchange:'NSE', sector:'Insurance',     price:1612.45,  change:8.90,    changePct:0.55,  volume:1234567,  mktCap:'1.6L Cr',  pe:64.2, high52:1921.85,  low52:1199.00 },
  { ticker:'UPL',        name:'UPL Ltd.',                      exchange:'NSE', sector:'Agro Chem',     price:524.30,   change:-4.20,   changePct:-0.80, volume:3456789,  mktCap:'0.4L Cr',  pe:28.4, high52:660.15,   low52:378.85  },
];
